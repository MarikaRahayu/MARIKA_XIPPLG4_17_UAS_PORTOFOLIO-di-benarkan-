    ...
    <div class="w-full max-w-md bg-white rounded-3xl shadow-2xl p-10 border border-pink-200">
        ...
        <div class="text-center mb-8">
            ...
            <div class="w-24 h-24 mx-auto rounded-full overflow-hidden border-4 border-pink-300 shadow-lg">
                <img src="<?php echo e(asset('images/profile.jpg.jpeg')); ?>"
                     alt="Marika"
        ...
        <div class="mt-8 text-center">
            <p class="text-sm text-gray-500">
                © <?php echo e(date('Y')); ?> Marika Portfolio
            </p>
        </div>
...
</html><?php /**PATH C:\laragon\www\MARIKA_XIPPLG4_17_UAS_PORTOFOLIO\resources\views/auth/login.blade.php ENDPATH**/ ?>