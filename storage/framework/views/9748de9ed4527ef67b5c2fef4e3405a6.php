...
<section class="pt-28 pb-16 min-h-screen
    ...
    <div class="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 px-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:scale-105 transition">
            ...
            <img src="<?php echo e(asset('images/a.jpeg')); ?>"
            ...
            <div class="p-5">
                ...
                <a href="<?php echo e(route('project.portfolio')); ?>"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:scale-105 transition">
            ...
            <img src="<?php echo e(asset('images/c.jpeg')); ?>"
                 class="w-full h-48 object-cover"
                 alt="POS">
            ...
            <div class="p-5">
                ...
                <a href="<?php echo e(route('project.student')); ?>"
                   class="bg-pink-500 text-white px-4 py-2 rounded-lg hover:bg-pink-600">
                    View Project
                </a>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:scale-105 transition">
            ...
            <div class="p-5">
                ...
                <a href="<?php echo e(route('project.game')); ?>"
                   class="bg-pink-500 text-white px-4 py-2 rounded-lg hover:bg-pink-600">
                    View Project
                </a>
...
</html><?php /**PATH C:\laragon\www\MARIKA_XIPPLG4_17_UAS_PORTOFOLIO\resources\views/projects.blade.php ENDPATH**/ ?>